...
if st.session_state.currentkey:
    ...
    personalprefrences=st.text_area(label='personal prefrences',value='I prefer to do more bench press than squats')
    ...
    if st.session_state.generate:
        with st.spinner("generating program"):
            ...
            Take these personal prefernces into the account ans suggest accordingly {personalprefrences}
